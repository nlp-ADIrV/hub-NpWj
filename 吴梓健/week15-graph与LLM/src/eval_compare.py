...
同一组对比调研问题，主 agent 派发的 subagent 分别用「并行(ThreadPool)」和
...
EVAL_QUESTIONS = [
    "新能源汽车对比调研：比亚迪汉EV、特斯拉Model 3、蔚来ET5 的价格、续航、动力参数对比",
    "新能源汽车对比调研：理想L7、问界M7、坦克500 Hi4-T 的价格、续航、动力参数对比",
    "新能源汽车对比调研：小鹏P7i、极氪001、小米SU7 的价格、续航、动力参数对比",
    "新能源汽车对比调研：比亚迪海豹、特斯拉Model Y、智己LS6 的价格、续航、动力参数对比",
]
